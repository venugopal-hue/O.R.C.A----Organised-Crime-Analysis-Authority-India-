...
export async function fetchOfficerApplications(): Promise<OfficerApplication[]> {
  try {
    ...
    console.warn("[O.R.C.A Admin] Firestore applications read failed. Falling back to browser sandbox.", error);
...
export async function fetchOfficers(): Promise<any[]> {
  try {
    ...
    console.warn("[O.R.C.A Admin] Firestore officers read failed. Falling back to browser sandbox.", error);
...
export async function fetchAuditLogs(): Promise<any[]> {
  try {
    ...
    console.warn("[O.R.C.A Admin] Firestore audit logs read failed. Falling back to browser sandbox.", error);
...
export async function fetchVerificationOversight(): Promise<any[]> {
  try {
    ...
    console.warn("[O.R.C.A Admin] Firestore verification records read failed. Falling back to browser sandbox.", error);
...
export async function fetchSystemSettings(): Promise<SystemSettings> {
  try {
    ...
    console.warn("[O.R.C.A Admin] Firestore settings read failed. Falling back to browser sandbox.", error);
...
export async function saveSystemSettings(settings: SystemSettings): Promise<void> {
  try {
    ...
    console.warn("[O.R.C.A Admin] Firestore settings write failed. Saving to browser sandbox.", error);
    setLocalData("orca_settings", settings);
  }
}
